...
public class DefaultTraining1Service implements Training1Service
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTraining1Service.class);
	...
	{
		return DefaultTraining1Service.class.getResourceAsStream("/training1/sap-hybris-platform.png");
	}
