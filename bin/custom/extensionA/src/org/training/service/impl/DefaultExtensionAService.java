...
public class DefaultExtensionAService implements ExtensionAService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtensionAService.class);
	...
	{
		return DefaultExtensionAService.class.getResourceAsStream("/extensionA/sap-hybris-platform.png");
	}
